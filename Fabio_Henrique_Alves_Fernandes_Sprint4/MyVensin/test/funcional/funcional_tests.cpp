...
void exponentialFuncionalTest() {
    System_Interface *population1 = new System ("Population 1", 100);
    System_Interface *population2 = new System ("Population 2", 0);

    ExponencialFlow* exponentialFlow = new ExponencialFlow("Unlimited Growth", population1, population2);

    Model_Interface *exponentialModel = new Model ("Exponential Model", 0.0);
...
void logisticalFuncionalTest() {
    System_Interface *population1 = new System ("Population 1", 100);
    System_Interface *population2 = new System ("Population 2", 10);

    LogisticFlow* logisticalFlow = new LogisticFlow("Limited Growth", population1, population2);
    Model_Interface *logisticalModel = new Model ("Logistic Model", 0);
...
void complexFuncionalTest() {
    System_Interface *Q1 = new System ("Q1", 100);
    System_Interface *Q2 = new System ("Q2", 0);
    System_Interface *Q3 = new System ("Q3", 100);
    System_Interface *Q4 = new System ("Q4", 0);
    System_Interface *Q5 = new System ("Q5", 0);
    ...
    Model_Interface *complexModel = new Model ("Complex Model", 0);
