...
void unit_system_constructor(){
    ...
    SystemInterface* system1 = new System();
    ...
    SystemInterface* system2 = new System("Test System", 10.0);
...
void UnitSystem::unit_system_copy_constructor(){
    ...
    SystemInterface* system2 = new System(*system1);
...
void unit_system_destructor(){
    ...
    SystemInterface* system = new System("Test System", 10.0);
    delete system;
...
void unit_system_sumOperator(){
    SystemInterface* sys1 = new System("Population 1", 100.0);
    SystemInterface* sys2 = new System("Population 2", 10.0);
