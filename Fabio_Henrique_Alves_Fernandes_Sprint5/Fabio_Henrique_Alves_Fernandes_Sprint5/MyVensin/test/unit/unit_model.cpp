...
void unit_model_constructor(){
    ...
    ModelInterface* model1 =  new Model();
    ...
    SystemInterface* system1 = new System("System 1");
    SystemInterface* system2 = new System("System 2");
    ...
    ModelInterface* model2 = new Model("Test Model", 1.0);
...
void unit_model_destructor(){
    ...
    SystemInterface* system2 = new System("System 2");
    ExponencialFlow* flow1 = new ExponencialFlow("Flow 1");
    ModelInterface* model = new Model("Test Model", 1.0);
...
void unit_model_getName(){
    ...
    ModelInterface* model = new Model("Test Model", 0.0);
...
void unit_model_addSystem(){
    ...
    SystemInterface* system = new System("System 1");
...
void unit_model_execute(){
    ...
    SystemInterface* pop1 = new System("Population 1", 100.0);
    SystemInterface* pop2 = new System("Population 2", 0.0);
    ExponencialFlow* expFlow = new ExponencialFlow("Unlimited Growth");
    expFlow->setSource (pop1);
    expFlow->setTarget (pop2);
    ModelInterface* expModel = new Model("Exponential Model", 0.0);
