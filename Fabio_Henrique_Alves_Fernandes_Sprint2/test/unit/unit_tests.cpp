...
void testFlow() {
    ...
    Flow *F1 = new TestFlow ("Test", S1, S2);
    assert (F1->getSource() == S1);
    assert (F1->getTarget() == S2);

    Flow *F2 = new TestFlow ("Test", S2, S1);
...
void testModel () {
    Model *M1 = new Model ("TestModel", 0);
    System *S1 = new System ("TestSystem1", 0);
    System *S2 = new System ("TestSystem2", 0);
    Flow *F1 = new TestFlow ("TestFlow", S1, S2);
