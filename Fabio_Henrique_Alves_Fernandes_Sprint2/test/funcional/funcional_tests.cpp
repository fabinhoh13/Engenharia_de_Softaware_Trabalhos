...
void exponentialFuncionalTest() {
    System *population1 = new System ("Population 1", 100);
    System *population2 = new System ("Population 2", 0);

    ExponencialFlow* exponentialFlow = new ExponencialFlow("Unlimited Growth", population1, population2);

    Model *exponentialModel = new Model ("Exponential Model", 0);
...
void logisticalFuncionalTest() {
    System *population1 = new System ("Population 1", 100);
    System *population2 = new System ("Population 2", 10);

    LogisticFlow* logisticalFlow = new LogisticFlow("Limited Growth", population1, population2);
    Model *logisticalModel = new Model ("Logistic Model", 0);
...
void complexFuncionalTest() {
    ...
    Model *complexModel = new Model ("Complex Model", 0);
